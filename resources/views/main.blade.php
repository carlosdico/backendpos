...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="{{ url('/') }}/statics/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome -->
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header">INVENTARIO</li>
             <li><a href="{{ url('/') }}/products"><i class="fa fa-link"></i> <span>Productos</span></a></li>
             <li><a href="{{ url('/') }}/categories"><i class="fa fa-link"></i> <span>Categorias</span></a></li>

            <li class="header">CONFIGURACION</li>
              <li><a href="{{ url('/') }}/floors"><i class="fa fa-link"></i> <span>Plantas</span></a></li>
